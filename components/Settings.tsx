          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <input
                        type="email"
                        defaultValue="info@greenwoodhigh.edu"
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      />
                    </div>
                  </div>
            ...
            {activeTab === 'email' && (
              <div>
                ...
                <p className="text-gray-600">Email server and template settings would be displayed here.</p>
              </div>
            )}
            ...
            {activeTab === 'integration' && (
              <div>
                ...
                <p className="text-gray-600">Integration settings for external services would be displayed here.</p>
              </div>
            )}
          </div>
        </div>
